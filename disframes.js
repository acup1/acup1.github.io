...
function createFrame(link){
  ...
  html="<div id='qwe'><div style='background-color:red;height:20px;text-align: right;'><a>o</a><a style='margin-right:5px;' onclick='"+'$("#qwe").remove()'+"'>x</a></div>"+"<iframe is='x-frame-bypass' width=100% height=100% src='"+link+"'></iframe>"+"</div>"
